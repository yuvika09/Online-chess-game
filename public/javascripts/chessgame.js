      ...
      if (square) {
        ...
        pieceElement.addEventListener("dragstart", (e) => {
          if (pieceElement.draggable) {
            ...
            e.dataTransfer.setData("text/plain", ""); //makes sure there is no problem in dragging
          }
        });
